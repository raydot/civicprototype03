...
interface HouseCandidatesScreenProps {
  onBack: () => void;
...
export default function HouseCandidatesScreen({
  onBack,
  onNavToConcerns,
  onNavToMappings,
  ...
  const candidates: Candidate[] = [
    {
      id: 'dingell',
      name: 'Debbie Dingell',
      summary: 'Strong environmental legislation, education cost reduction',
      match: true,
      matchPercentage: 94,
      website: 'debbiedingellforcongress.com',
      websiteUrl: 'https://debbiedingellforcongress.com/'
    },
    {
      id: 'williams',
      name: 'Whittney Williams',
      summary: 'Pro-individual liberty, less emphasis on education',
      match: true,
      matchPercentage: 58,
      website: 'winwithwilliams.com',
      websiteUrl: 'https://winwithwilliams.com/'
    }
  ];

  const renderMatchIcon = (candidate: Candidate) => {
    if (candidate.id === 'williams') {
  ...
  const getWebsitePreviewForCandidate = (candidateId: string | undefined) => {
    if (candidateId === 'dingell') {
      return {
        title: "Debbie Dingell for Congress",
        ...
        description: "Veteran Representative advocating for environmental protection and affordable education for Michigan families."
      };
    }
    
    if (candidateId === 'williams') {
      return {
        title: "Whittney Williams for Congress",
        tagline: "Liberty. Opportunity. Prosperity.",
        sections: [
          "About Whittney",
          "Individual Liberty",
          "Free Markets",
        ...
        description: "Business owner focused on individual freedoms and free market solutions for Michigan."
      };
    }
  ...
  const getXPostsForCandidate = (candidateId: string | undefined) => {
    if (candidateId === 'dingell') {
      return [
        { post: "Clean energy isn't just about the environment - it's about creating good-paying jobs for Michigan workers and reducing energy costs for families.", time: "3h" },
        { post: "No family should go into debt for decades just to give their kids a college education. We need real solutions to make higher education affordable.", time: "6h" },
        { post: "Government corruption undermines trust in democracy. That's why I support transparency measures and ethics reforms.", time: "1d" }
      ];
    }
    
    if (candidateId === 'williams') {
      return [
        { post: "Individual liberty is the foundation of our republic. Government should protect our freedoms, not restrict them.", time: "4h" },
        { post: "Free markets, not government mandates, create prosperity. We need policies that unleash entrepreneurship.", time: "7h" },
        { post: "Michigan families know how to spend their money better than Washington bureaucrats do.", time: "2d" }
      ];
    }
    
    return [
      { post: "Democracy thrives when every voice is heard and protected. We must defend civil liberties for all Americans.", time: "2h" },
      { post: "The future of our district depends on bold action today. Time to lead, not follow.", time: "5h" },
  ...
  const getHeadlinesForCandidate = (candidateId: string | undefined) => {
    if (candidateId === 'dingell') {
      return [
        { headline: "Dingell Introduces Clean Energy Jobs Bill", source: "Detroit Free Press", time: "3 hours ago" },
        { headline: "Rep. Dingell Champions College Affordability", source: "MLive", time: "1 day ago" },
        { headline: "Dingell's Environmental Record Highlighted", source: "Michigan Radio", time: "2 days ago" },
        { headline: "House Representative Outlines Climate Plan", source: "Associated Press", time: "1 week ago" }
      ];
    }
    
    if (candidateId === 'williams') {
      return [
        { headline: "Williams Campaign Focuses on Individual Liberty", source: "Grand Rapids Press", time: "5 hours ago" },
        { headline: "Business Owner Outlines Economic Growth Plan", source: "Detroit News", time: "1 day ago" },
        { headline: "Williams Emphasizes Free Market Solutions", source: "Crain's Detroit", time: "3 days ago" },
        { headline: "Congressional Candidate Supports Limited Government", source: "Politico", time: "1 week ago" }
      ];
    }
    
    return [
      { headline: "House Race Features Policy Contrasts", source: "Reuters", time: "2 hours ago" },
      { headline: "Congressional Candidates Debate Key Issues", source: "CNN", time: "8 hours ago" },
      { headline: "Campaign Focus Shifts to Local Concerns", source: "Washington Post", time: "1 day ago" },
      { headline: "House Hopefuls Outline District Priorities", source: "NBC News", time: "3 days ago" }
    ];
  };
    ...
    <div className="h-full bg-white flex flex-col relative">
      ...
      <div className="flex-shrink-0 flex items-center justify-between px-4 py-4 border-b border-gray-100 bg-white">
        ...
        <div className="text-center">
          <h1 className="text-lg font-medium">U.S. House</h1>
          <p className="text-sm text-gray-600">District MI-6</p>
        </div>
